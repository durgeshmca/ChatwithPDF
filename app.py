...
def get_conversational_chain():
    prompt_template = """
    You are an assistant of a Therepist . Your name is TherepistBot. Act as a support person.
    Answer the question as detailed as possible from the provided context, make sure to provide all the details, you can reply greetings\n\n
    Context:\n {context}?\n
    Question: \n{question}\n
